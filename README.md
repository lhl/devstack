...
- [lhl/pi-continue-after-compaction](https://github.com/lhl/pi-continue-after-compaction) - watches auto-threshold compactions only and sends an extension-originated `continue` if no next turn starts. Manual `/compact` and `/pi-vcc` are ignored.
