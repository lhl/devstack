...
- [[tools/pi-agent]] — Pi coding agent: minimal extensible terminal coding harness (pi.dev), plugin stack, pi-zentui customization log, Codex quota status, account rotation
